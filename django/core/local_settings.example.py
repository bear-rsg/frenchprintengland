...
ALLOWED_HOSTS = ['*']/['frenchprintengland.bham.ac.uk']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'frenchprintengland.sqlite3'),
        'TEST': {
            'NAME': os.path.join(BASE_DIR, 'frenchprintengland_TEST.sqlite3'),
        },
    }
}
